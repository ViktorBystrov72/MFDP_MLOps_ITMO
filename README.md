...
**Пилот:** регион **Тюмень**, исторические данные **с 2024 г.** Дополнительные внешние данные на первом этапе не требуются.
...
- экспертная выборочная проверка аналитиками Neolithic и A/B: новая модель vs текущие правила на историческом периоде.
...
| Подэтап | Действия в проекте |
|---------|-------------------|
| Выбор алгоритма | Базлайн: текущие правила Neolithic + fuzzy matching; ML: градиентный бустинг / классификатор/ранжирование пар; опционально embeddings |
| Планирование тестирования | Train / val / test с временным сплитом; кросс-валидация по ЖК (пилот Тюмень); ручной hold-out golden set |
